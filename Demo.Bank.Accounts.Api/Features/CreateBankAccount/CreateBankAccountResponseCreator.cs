...
public class CreateBankAccountResponseCreator : IResponseCreator<CreateBankAccountRequest>
{
    public IActionResult CreateResponse(CreateBankAccountRequest request, Result operation)
    {
        if (operation.Status) return new AcceptedResult();
